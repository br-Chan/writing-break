---
title: The Black Toyota of Gondor
description: M U M U M U' M U' M U2 M U' M U'
date: 2025-08-04 23:56:00
tags:
---

## Void Cube Videos

<img src="https://static.wikia.nocookie.net/rubiks/images/5/51/Rubik%27svoid.jpg/revision/latest?cb=20150509074432" alt="Void Cube" />
...
The only catch is that lacking the centres causes a problem called "parity", a seemingly random occurrence where you can't solve the cube through normal means, and you must use a [:different algorithm](#x-different-algorithm) to solve the parity before continuing the normal solution. Parities also occur in 4x4x4 cubes, and probably every cube that has something wacky going on with the centres.

[:Video](https://youtu.be/oWYh_Lq_2ok?si=DjQ7j87I3SMi2nW3) by Noah Richardson
|                                   |     |
|-----------------------------------|-----|
| **Upload date**                   | 7/4/17 |
...
[:Video](https://youtu.be/SN1pjmwY0Rc?si=GyDyH95Uf2DVvjlc) by ElevatorRubiksFan Belcher
|                                   |     |
|-----------------------------------|-----|
| **Upload date**                   | 5/8/15 |
| **Remember watching before?**     | Yes |
...
7. Increasing your difficulty

5. "Never farm or mine" project: to automate things to a point that you never need to go caving or manually farm things yourself.

6. Trying redstone

## 10 AWESOME Movie Themes by John Williams

[:Video](https://youtu.be/Bwa2e8teTOg?si=BLA1X3ugZ8Yolg24) by Sheet Music Boss
|                                   |     |
|-----------------------------------|-----|
| **Upload date**                   | 22/10/18 |
| **Remember watching before?**     | Yes |
| **Should have watched sooner?**   | N/A |
| **Should you watch?**             | Yes |

It takes a lot of skill to transition from one song to completely different song (tempo, key, style, etc). They were pretty top notch in this video.

## ⚔️ The Lord of The Rings | Real Scale in 3D ⚔️

[:Video](https://www.youtube.com/watch?v=ThbRstrgofM) by MetaBallStudios
|                                   |     |
|-----------------------------------|-----|
| **Upload date**                   | 5/11/18 |
| **Remember watching before?**     | Yes |
...
[:Video](https://www.youtube.com/watch?v=OkaiKnXj0T0) by TutorialsByHugo
|                                   |     |
|-----------------------------------|-----|
| **Upload date**                   | 8/7/18 |
| **Remember watching before?**     | Maybe |
| **Should have watched sooner?**   | Yes |
